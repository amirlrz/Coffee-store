      ...
      {isSuccess && showAnimation ? (
        ...
        >
          ...
          <button
            type="button"
            onClick={closeModal}
            className="absolute top-3 right-3 z-30 w-7 h-7 flex items-center justify-center rounded-full bg-gray-100 hover:bg-red-100 hover:text-specialRed text-gray-400 transition-all duration-200"
          >
          ...
          <div className="inputs max-sm:w-[250px] max-sm:mr-5 flex flex-col ml-60 gap-3">
            ...
            <div className="input-group relative ml-28">
              ...
              <button
                ...
                className="absolute right-2 top-1 text-gray-400 hover:text-gray-500 transition-colors"
              >
                <i
                  className={`bi ${
